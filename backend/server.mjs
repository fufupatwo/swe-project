...
import {createUserRoute, loginRoute, adminLoginRoute, adminBanUserRoute, forgotPasswordRoute, updatePasswordRoute} from "./routes.mjs";
...
app.post("/update_password", updatePasswordRoute)
